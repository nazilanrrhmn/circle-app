  ...
  return (
    <Box>
      ...
      <PostDetail
        ...
        createdAt={new Date(thread.createdAt).toLocaleString()} // Pastikan ini mengubah Date menjadi string
      ...
      {thread.replies?.map((reply) => (
        <RepliesItem
          ...
          like={
            reply.like?.length ?? 0
          } /* Pastikan like ada dan berupa array */
          postImage={reply.image || ""}
          createdAt={new Date(reply.createdAt).toLocaleString()} // Pastikan ini mengubah Date menjadi string
          authorId={reply.author?.id || 0} /* Tambahkan authorId */
        />
      ))}
    </Box>
  );
