...
export default function ProtectedRoutes() {
  ...
  // Cek apakah auth.entities.id sudah siap dan terisi
  if (auth.entities && typeof auth.entities.id === "number") {
    return (
      <div>
        <Outlet />
      </div>
  ...
  // Jika tidak ada id dan loading selesai, redirect ke login
  return <Navigate to="/login" />;
}
